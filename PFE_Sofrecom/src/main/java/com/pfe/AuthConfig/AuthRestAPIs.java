 ...
 * 
 * import com.pfe.dao.RoleRepository; import com.pfe.dao.UserRepository; import
 * com.pfe.dto.JwtResponse; import com.pfe.entities.LoginForm; import
 * com.pfe.entities.Role; import com.pfe.entities.RoleName; import
 * com.pfe.entities.SignUpForm; import com.pfe.entities.User;
 * 
 * 
 * 
 ...
 * @RestController
 * 
 * @RequestMapping("/api/auth") public class AuthRestAPIs {
 * 
 ...
 * authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
 * 
 ...
 * 
 * String jwt = jwtProvider.generateJwtToken(authentication); return
 * ResponseEntity.ok(new JwtResponse(jwt)); }
 * 
 * @PostMapping("/signup") public ResponseEntity<String>
 * registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
 ...
 * ResponseEntity<String>("Fail -> Email is already in use!",
 * HttpStatus.BAD_REQUEST); }
 * 
